...
sample_solution: Provide a working solution for the generated problem that follows coding best practices. The solution should be implemented in the specified language/framework.
